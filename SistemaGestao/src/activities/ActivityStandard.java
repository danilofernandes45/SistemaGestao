...
public abstract class ActivityStandard implements Activity{
	private String name;
	...
	public ActivityStandard(String name, String description, User userResponsible, ArrayList<User> listParticipants, SupportMaterial material) {
		this.name = name;
	...
	public String toString() {
		...
		return "Nome: " + this.name + "\tTipo de Atividade:" + this.getType()+"\n"+
